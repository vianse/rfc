...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { comercio_id: @empresa.comercio_id, name: @empresa.name, razon: @empresa.razon, user_id: @empresa.user_id }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { comercio_id: @empresa.comercio_id, name: @empresa.name, razon: @empresa.razon, user_id: @empresa.user_id }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
